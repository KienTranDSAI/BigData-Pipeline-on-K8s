...
kafka_options = {
    ...
    "subscribe": "movies"            # Kafka topic name
}
    ...
    if conn:
        ...
        try:
            ...
            for row in df.collect():
                ...
                query = f"INSERT INTO test_table (id, name, age) VALUES (%s, %s, %s);"
                cursor.execute(query, (id, name, age))
                
            # Commit the transaction
            conn.commit()
            print(f"Batch {batch_id}: Data inserted successfully into test_table.")
